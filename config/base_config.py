...
# Whether to store only author-related comments.
# Author-related means: comment author is note author, or the comment is liked by author.
ENABLE_GET_AUTHOR_RELATED_COMMENTS = True
